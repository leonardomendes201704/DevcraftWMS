# TASK-0033 - Manual da tela Logs - Errors

## Resumo
Criar o manual HTML (Help) para a tela **Logs / Errors** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Logs / Errors.
...
- Botao **Help** no Index da tela Logs / Errors.
