# TASK-0038 - Manual da tela UI Showcase

## Resumo
Criar o manual HTML (Help) para a tela **UI Showcase** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela UI Showcase.
...
- Botao **Help** no Index da tela UI Showcase.
