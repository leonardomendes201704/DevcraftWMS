# TASK-0027 - Manual da tela Sections

## Resumo
Criar o manual HTML (Help) para a tela **Sections** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Sections.
...
- Botao **Help** no Index da tela Sections.
