# TASK-0030 - Manual da tela Locations

## Resumo
Criar o manual HTML (Help) para a tela **Locations** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Locations.
...
- Botao **Help** no Index da tela Locations.
