# TASK-0031 - Manual da tela Inventory Balances

## Resumo
Criar o manual HTML (Help) para a tela **Inventory Balances** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Inventory Balances.
...
- Botao **Help** no Index da tela Inventory Balances.
