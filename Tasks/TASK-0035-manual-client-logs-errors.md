# TASK-0035 - Manual da tela Client Logs - Errors

## Resumo
Criar o manual HTML (Help) para a tela **Client Logs / Errors** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Client Logs / Errors.
...
- Botao **Help** no Index da tela Client Logs / Errors.
