# TASK-0024 - Manual da tela UoM

## Resumo
Criar o manual HTML (Help) para a tela **Units of Measure** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Units of Measure.
...
- Botao **Help** no Index da tela Units of Measure.
