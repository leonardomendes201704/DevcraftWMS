# TASK-0022 - Manual da tela Products

## Resumo
Criar o manual HTML (Help) para a tela **Products (SKU)** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Products (SKU).
...
- Botao **Help** no Index da tela Products (SKU).
