# TASK-0037 - Manual da tela Settings

## Resumo
Criar o manual HTML (Help) para a tela **Settings** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Settings.
...
- Botao **Help** no Index da tela Settings.
