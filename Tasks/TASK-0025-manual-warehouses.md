# TASK-0025 - Manual da tela Warehouses

## Resumo
Criar o manual HTML (Help) para a tela **Warehouses** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Warehouses.
...
- Botao **Help** no Index da tela Warehouses.
