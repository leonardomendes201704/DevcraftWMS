# TASK-0026 - Manual da tela Sectors

## Resumo
Criar o manual HTML (Help) para a tela **Sectors** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Sectors.
...
- Botao **Help** no Index da tela Sectors.
