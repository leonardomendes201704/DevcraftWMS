# TASK-0023 - Manual da tela Lots

## Resumo
Criar o manual HTML (Help) para a tela **Lots / Validades** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Lots / Validades.
...
- Botao **Help** no Index da tela Lots / Validades.
