# TASK-0021 - Manual da tela Customers

## Resumo
Criar o manual HTML (Help) para a tela **Customers** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Customers.
...
- Botao **Help** no Index da tela Customers.
