# TASK-0019 - Manual da tela Dashboard

## Resumo
Criar o manual HTML (Help) para a tela **Dashboard (Home)** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Dashboard (Home).
...
- Botao **Help** no Index da tela Dashboard (Home).
