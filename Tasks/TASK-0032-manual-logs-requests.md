# TASK-0032 - Manual da tela Logs - Requests

## Resumo
Criar o manual HTML (Help) para a tela **Logs / Requests** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Logs / Requests.
...
- Botao **Help** no Index da tela Logs / Requests.
