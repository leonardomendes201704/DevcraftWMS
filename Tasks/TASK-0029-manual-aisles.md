# TASK-0029 - Manual da tela Aisles

## Resumo
Criar o manual HTML (Help) para a tela **Aisles** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Aisles.
...
- Botao **Help** no Index da tela Aisles.
