# TASK-0036 - Manual da tela Email Test

## Resumo
Criar o manual HTML (Help) para a tela **Email Test** no DemoMvc, com botao "Help" no Index e conteudo que explique a tela e seus fluxos relacionados (CRUDs e telas filhas).
...
## Objetivos
- Adicionar botao **Help** no Index da tela Email Test.
...
- Botao **Help** no Index da tela Email Test.
