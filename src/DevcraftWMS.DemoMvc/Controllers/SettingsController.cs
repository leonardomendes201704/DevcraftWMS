...
using DevcraftWMS.DemoMvc.Infrastructure.Settings;
using DevcraftWMS.DemoMvc.ViewModels.Settings;
...
public sealed class SettingsController : Controller
{
    ...
    private readonly Microsoft.Extensions.Options.IOptionsMonitor<DevcraftWMS.DemoMvc.Infrastructure.Telemetry.ClientTelemetryOptions> _telemetryOptions;
    private readonly IUiSettingsStore _settingsStore;
    private readonly DevcraftWMS.DemoMvc.ApiClients.SettingsApiClient _settingsApiClient;
    private readonly DevcraftWMS.DemoMvc.Infrastructure.Settings.FrontendSettingsReader _frontendSettingsReader;
    ...
    public SettingsController(
        ...
        DevcraftWMS.DemoMvc.ApiClients.SettingsApiClient settingsApiClient,
        DevcraftWMS.DemoMvc.Infrastructure.Settings.FrontendSettingsReader frontendSettingsReader)
    {
        _options = options;
