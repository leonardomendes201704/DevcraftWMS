...
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.PermissionsApiClient>();
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.RolesApiClient>();
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.SettingsApiClient>();
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.UsersApiClient>();
...
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.CostCentersApiClient>();
...
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.AsnsApiClient>();
...
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.ReturnsApiClient>();
builder.Services.AddScoped<DevcraftWMS.DemoMvc.ApiClients.DockSchedulesApiClient>();
