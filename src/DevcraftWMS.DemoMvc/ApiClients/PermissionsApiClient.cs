...
public sealed class PermissionsApiClient : ApiClientBase
{
    ...
    public Task<ApiResult<PagedResultDto<PermissionListItemViewModel>>> ListAsync(PermissionQuery query, CancellationToken cancellationToken)
    {
        var basePath = "/api/permissions";
        ...
        return GetAsync<PagedResultDto<PermissionListItemViewModel>>(url, cancellationToken);
    }
}
