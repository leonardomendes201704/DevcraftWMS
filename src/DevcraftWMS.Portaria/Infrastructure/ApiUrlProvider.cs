...
{
    private readonly IOptionsMonitor<PortariaOptions> _options;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public ApiUrlProvider(IOptionsMonitor<PortariaOptions> options, IHttpContextAccessor httpContextAccessor)
    {
        _options = options;
