# agent.md - DevcraftWMS.Portal

## Purpose
- Customer Portal UI for inbound (ASN/OE) interactions and reporting.

## Allowed dependencies
- ASP.NET Core MVC, Bootstrap 5, Bootstrap Icons.
- Portal ApiClients (HTTP only), ViewModels, Infrastructure helpers.
