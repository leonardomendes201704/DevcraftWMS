...
public sealed class UpdateGateCheckinCommandValidator : AbstractValidator<UpdateGateCheckinCommand>
{
    public UpdateGateCheckinCommandValidator()
    {
    ...
    private static bool HasInboundOrderOrDocument(UpdateGateCheckinCommand command)
    {
