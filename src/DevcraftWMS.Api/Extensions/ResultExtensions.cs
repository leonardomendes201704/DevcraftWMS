...
public static class ResultExtensions
{
    public static IActionResult ToActionResult<T>(this ControllerBase controller, RequestResult<T> result)
    {
        ...
        var problem = result.ErrorCode switch
        {
            ...
            "gate_checkins.checkin.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            },
            "gate_checkins.inbound_order.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            ...
            "receipt_counts.receipt.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            },
            "receipt_counts.inbound_order.required" => new ProblemDetails
            {
                Title = "Bad Request",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status400BadRequest
            },
            "receipt_counts.item.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            },
            "receipt_counts.count.invalid_quantity" => new ProblemDetails
            {
                Title = "Bad Request",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status400BadRequest
            },
            "unit_loads.unit_load.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            },
            "unit_loads.receipt.not_found" => new ProblemDetails
            {
                Title = "Not Found",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status404NotFound
            },
            "unit_loads.unit_load.status_locked" => new ProblemDetails
            {
                Title = "Bad Request",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status400BadRequest
            },
            "unit_loads.receipt.status_locked" => new ProblemDetails
            {
                Title = "Bad Request",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status400BadRequest
            },
            "unit_loads.sscc.unavailable" => new ProblemDetails
            {
                Title = "Conflict",
                Detail = result.ErrorMessage,
                Status = StatusCodes.Status409Conflict
