...
- Added warehouse details hierarchy report (sectors, sections, structures, locations) with summary counts.
...
- 2026-02-06 - Persisted DemoMvc sidebar scroll position between page loads.
- 2026-02-06 - Adjusted DemoMvc content scrolling to keep sidebar fixed with independent scroll.
...
## 2026-02-06
- Aligned DemoMvc login UI with Portal/Portaria visual identity.
- Added DemoMvc sidebar drawer toggle with independent scroll.
